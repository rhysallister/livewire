...
5	ISOLATOR	ABC	t	\N	01010000207A0D000033333333875C1E4133333333020F3F41
...
SELECT results_eq(
  $$ SELECT count(*) FROM livewire_testing.__nodes where status = 'SOURCE'$$,
  ' VALUES (4::bigint) ',
  'Confirm that there are 4 source nodes after running lw_generate'
  );
